...
release: main.c raytracer.o texture_loader.o texture.o angle.o render_canvas.o render_line.o render_polygon_2d.o map.o
	gcc main.c raytracer.o texture_loader.o texture.o angle.o render_canvas.o render_line.o render_polygon_2d.o map.o -o release -lSDL2 -lSDL2_image -lm -g -O3 -fopenmp 
