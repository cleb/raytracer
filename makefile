...
release: main.c raytracer.o texture_loader.o texture.o angle.o render_canvas.o
	gcc main.c raytracer.o texture_loader.o texture.o angle.o render_canvas.o -o release -lSDL2 -lSDL2_image -lm -O3 -fopenmp
